...
class ProductPagese extends StatefulWidget {
  const ProductPagese({super.key});

  @override
  State<ProductPagese> createState() => _ProductPageseState();
}

class _ProductPageseState extends State<ProductPagese> {
  int selectedSize = 41;
  int quantity = 1;
